           ...
           <main>
            <div class="container-fluid px-4">
              ...
              <div class="col-md-6 col-12 mx-auto">
                <form:form method="post" action="/admin/product/update/${id}" modelAttribute="updateProduct" class="row"
                  ...
                  <c:set var="errorDetailDesc">
                    <form:errors path="productDetail.detailDesc" cssClass="invalid-feedback" />
                  </c:set>
                  <c:set var="errorShortDesc">
                    <form:errors path="productDetail.shortDesc" cssClass="invalid-feedback" />
                  </c:set>
    ...
    <script src="/js/scripts.js"></script>
     <script>
        $(document).ready(() => {
            ...
            const avatarOrigin = "${updateProduct.image}";
            if (avatarOrigin) {
                const img = "/images/product/" + avatarOrigin;
